...
public class PackageUtils {
    ...
    /**
     * Check whether the program installation
     * 
     * @param context
     * @param packageName
     * @return
    ...
    public static final int install(Context context, String filePath) {
        ...
        return installNormal(context, filePath) ? INSTALL_BY_SYSTEM : INSTALL_FAILED_INVALID_URI;
    }
    ...
    public static boolean uninstallNormal(Context context, String packageName) {
        ...
        Intent i =
            new Intent(Intent.ACTION_DELETE, Uri.parse(new StringBuilder(32).append("package:").append(packageName)
                    .toString()));
        i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        context.startActivity(i);
        return true;
     ...
     * @return
     */
    public static final String getAppVersionName(Context pContext,String pPackageName){
